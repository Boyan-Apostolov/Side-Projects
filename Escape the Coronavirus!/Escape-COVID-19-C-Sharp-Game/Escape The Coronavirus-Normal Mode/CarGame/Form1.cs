...
namespace CarGame
{
    public partial class Form1 : Form
    {
        ...
        //Randomly Move Enemies Function
        ...
        void checkIfGameOver()
        {
            ...
            //Win
            if (collectedCoins >= 40)
            {
                timer1.Enabled = false;
                isOver = true;
                over.Visible = true;
                over.Text = "Victory!";
                over.Location = new Point(127, 70);
                button2.Visible = true;
                button1.Visible = true;
                label4.Text = "You got all pills and escaped";
                label4.Visible = true;
                label5.Text = "the COVID-19 !";
                label5.Font = new Font("Microsoft Sans Serif", 24, FontStyle.Bold);
                label5.Location = new Point(60, 256);
                label5.Visible = true;
                label6.Text = "Now try the Endless Mode!";
